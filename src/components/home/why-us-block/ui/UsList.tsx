  ...
  return (
    <ul className="w-[calc(100%+32px)] pr-[16px] mdPlus:pr-0 md:justify-center scrollbar-hide snap-x snap-mandatory ml-[-16px] gap-[8px] flex mb-[138px] overflow-x-scroll">
      <UsItem
        ...
        subTitle={`Предложим вам самый выгодный и низкий курс на текущий момент`}
      />
      <UsItem
        img={<WranIcon />}
        title="Риски на нас"
        subTitle={`Мы в ответе за ваши средства и если оплата не пройдет,вернем средства`}
      />
      <UsItem
        img={<OfficeIcon />}
        title="Работаем в офисе"
        subTitle={`Вы всегда можете\nприехать и лично\nпознакомиться с нашей\nкомандой.`}
      />
    </ul>
  );
}
