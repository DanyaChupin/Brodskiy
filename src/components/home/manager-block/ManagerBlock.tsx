  ...
  return (
    <section className="pb-[108px] max-width lg:pb-[80px]">
      ...
      <ul className="overflow-x-scroll mdPlus:max-h-[366px] xl:max-h-[523px] lg:max-h-[400px] mdPlus:w-full mdPlus:overflow-x-hidden w-[calc(100%+32px)] pr-[16px] pl-[16px] snap-x snap-mandatory gap-x-[8px] mdPlus:gap-[18px] ml-[-16px] mdPlus:flex-wrap mdPlus:flex-col mdPlus:ml-0 flex scrollbar-hide">
        <ManageItem
          idDot="1"
          className="mdPlus:w-[28%] mdPlus:h-[366px] lg:h-[400px] xl:h-[523px]"
          title="Круглосуточная поддержка"
          subTitle="Наша команда гарантирует вам круглосуточное решение любых вопросов и спорных моментов, которые могут возникнуть в ходе сделок."
          background={
            <>
              <div
                style={{
        ...
        <ManageItem
          idDot="2"
          className="mdPlus:w-[44%] mdPlus:h-[150px] lg:h-[200px] xl:h-[219px]"
          title="Оперативное решение"
          subTitle="Сотрудники нашей поддержки всегда готовы предоставить вам оперативное решение абсолютно любого вопроса"
          background={
            <>
              <div
                style={{
        ...
        />
        <ManageItem
          className="mdPlus:w-[44%] mdPlus:h-[198px] lg:h-[182px] xl:h-[286px]"
          title="Тщательно отобранный персонал"
          idDot="3"
          subTitle="Каждый наш сотрудник проходит тщательный отбор и подготовку перед тем, как начать работу на своей должности. Именно поэтому мы можем гарантировать высокое качество решения вопросов"
          background={
            <>
              <div
                style={{
        ...
        <ManageItem
          idDot="4"
          className="mdPlus:h-[198px] mdPlus:w-[25%] lg:h-[231px] xl:h-[252px]"
          title="Индивидуальный подход к клиенту"
          subTitle="Каждый наш сотрудник подбирает индивидуальный подход ко всем, кто пользуется услугами обменника."
          background={
            <>
              <div
                style={{
        ...
        <ManageItem
          idDot="5"
          className="mdPlus:h-[150px] mdPlus:w-[25%] xl:h-[252px]"
          title="Персональный менеджер"
          subTitle="Окажет вам поддержку при решении любых ситуаций."
          background={
            <>
              <div
                style={{
